                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Edit staff</h4>
                                                        <form action="{{url('admin/team/update-staff/'. $staff->id)}}" method="POST">
                                                            @csrf
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                    <label for="name">Names</label>
                                                                    <input type="text" name="names" class="form-control @error('names') is-invalid @enderror" value="{{$staff->name}}" placeholder="John Doe">
                                                                    @error('names')
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{$staff->email}}" placeholder="johndoe@gmail.com">
                                                                    @error('email')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"  value="{{$staff->phone}}" placeholder="0712345678">
                                                                    @error('phone')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <label for="email">Docket</label>
                                                                    <input type="text" name="docket" class="form-control @error('docket') is-invalid @enderror" value="{{$staff->docket}}"  placeholder="Staff">
                                                                    @error('docket')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
