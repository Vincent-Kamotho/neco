                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Add staff</h4>
                                                        <form action="{{url('admin/team/save-staff')}}" method="POST">
                                                            @csrf
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input type="text" name="docket" class="form-control @error('docket') is-invalid @enderror" value="{{ old('docket') }}"  placeholder="Staff">
                                                                    @error('docket')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
