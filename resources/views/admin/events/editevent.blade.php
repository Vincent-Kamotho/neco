                                                        ...
                                                        <form action="{{url('admin/events/update-event/'.$event->id)}}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{$event->title}}" placeholder="Event Title">
                                                                    @error('title')
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    ...
                                                                    <input type="time" name="time" class="form-control @error('time') is-invalid @enderror" value="{{$event->start_time}}">
                                                                    @error('time')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-3">
                                                                    ...
                                                                    <input type="text" name="venue" class="form-control @error('venue') is-invalid @enderror" value="{{$event->venue}}" placeholder="Event Venue">
                                                                    @error('title')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    ...
                                                                    <input type="charges" name="charges" class="form-control @error('charges') is-invalid @enderror" value="{{$event->charges}}" placeholder="KES">
                                                                    @error('charges')
                                                                       <div style="color:red">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    @if ($event->image)
                                                                    <img src="{{ asset($event->image) }}" alt="Item Image" style="max-width: 200px;">
                                                                    @endif
                                                                </div>
                                                                </div>
