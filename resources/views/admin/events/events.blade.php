                                                ...
                                                <div class="card">
                                                    <div class="row align-items-end">
                                                        <div class="col-lg-8">
                                                            <div class="page-header-title">
                                                                <div class="d-inline">
                                                                    <h6 style="margin-left:20px;">Upcoming Events</h6>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="page-header-breadcrumb">
                                                                <a href="{{url('admin/events/create-event')}}"
                                                                    style="margin-top:10px; margin-right:20px;"
                                                                    class="btn btn-success">Add/Configure Event</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="simpletable"
                                                                ...
                                                                <tbody>
                                                                    <td style="width: 50px; height: 50px;">{{$event->title}}</td>
                                                                    <td>{{$event->date}}</td>
                                                                    <td>{{$event->start_time}}</td>
                                                                    <td>{{$event->day}}</td>
                                                                    <td>{{$event->venue}}</td>
                                                                    <td>{{$event->charges}}</td>
                                                                    <td><img src="{{asset($event->image)}}" alt="Product Image" style="width: 200px; height: 100px; object-fit: cover;"></td>
                                                                    <td>
                                                                        <a href="{{url('admin/events/edit-event/'. $event->id)}}" class="btn btn-success">Edit</a>
                                                                        <a href="{{url('admin/events/delete-event/'.$event->id)}}" class="btn btn-danger">Delete</a>
                                                                    </td>
                                                                </tbody>
                                                                @endforeach
                                                            </table>
