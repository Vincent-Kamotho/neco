    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <p>Healthy relationships are a cornerstone of a fulfilling life, 
                            but they can face challenges that often feel overwhelming. 
                            As dedicated psychologists specializing in relationship therapy, 
                            we are here to help individuals and couples find their way back to love, 
                            understanding, and connection. Our approach is grounded in empathy, 
                            effective communication, and evidence-based techniques to address a wide range of 
                            relationship issues, including communication breakdowns, trust issues, conflicts, 
                            and emotional distance. 
                            </p>
                        <p>We believe that every relationship is unique, 
                            and we tailor our therapeutic approach to meet your specific needs and goals. 
                            Whether you're grappling with issues in your romantic relationship, 
                            family dynamics, friendships, or workplace relationships, 
                            we provide a safe and non-judgmental space where you can openly explore your challenges 
                            and work collaboratively to find practical solutions. Our ultimate aim is to empower
                            you with the skills and insights needed to build healthier, happier, 
                            and more harmonious connections with the people who matter most in your life. 
                            </p>
                        <p class="mt-5"><a href="{{url('contact-us')}}" class="btn btn-primary">Get In Touch</a></p>
                    </div>
                    <div class="col-lg-5 ml-auto">
                        <img src="assets/frontend/images/relationship_problems.jpg" style="height:300px;" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
