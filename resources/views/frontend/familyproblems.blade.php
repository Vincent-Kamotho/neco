    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <p>Family dynamics can be complex, and it's not uncommon for households to 
                            encounter a variety of challenges over time. 
                            As a dedicated psychologist organization specializing in family therapy, 
                            we are here to help families navigate these difficulties, foster healthier 
                            relationships, and build a more harmonious living environment. 
                            </p>
                        <p> Whether you're grappling with communication issues, conflicts, 
                            parenting dilemmas, or major life transitions, 
                            we offer a safe and non-judgmental space for open and honest discussions. 
                            Our therapeutic techniques are rooted in evidence-based practices, 
                            focusing on improving family communication, strengthening bonds, 
                            and equipping each member with the skills necessary to cope with challenges. 
                            </p>
                        <p> If your family is facing difficulties, don't hesitate to reach out. 
                            Together, we can embark on a journey of healing and growth, 
                            fostering a more cohesive and loving family environment where each member can flourish. 
                            </p>
                        <p class="mt-5"><a href="{{url('contact-us')}}" class="btn btn-primary">Get In Touch</a></p>
                    </div>
                    <div class="col-lg-5 ml-auto">
                        <img src="assets/frontend/images/family_problems.jpg" style="height:300px;" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
