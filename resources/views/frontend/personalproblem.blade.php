    ...
    <div class="site-wrap">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 mt-lg-5 mr-auto text-left align-self-end align-self-md-center">
                        <h1>Personal Problems Analysis</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <p>At Newness Counselling Organization, one of the most important aspects of our work is to help clients 
                            identify and address any personal problems they may be facing in their lives. 
                            Our goal is to provide clients with the skills and insights they need to overcome any challenges they may be facing
                            and to live their best lives!</p>
                        <p>We recognize that each person's problems are unique to their individual circumstances. 
                            That's why we take the time to listen carefully to each client and to understand their 
                            specific situations before developing a treatment plan. 
                            We use a variety of cognitive behavioral approaches and tools to help clients gain insight into their thoughts, 
                            emotions, and behavior patterns. 
                            This approach allows clients to better understand why they react in certain ways 
                            and how they may change those patterns.</p>
                        <p>Personal problems analysis is a vital component of our work, as it helps clients to better understand and cope with their challenges. 
                            By providing a safe and supportive environment for clients to explore their experiences, 
                            we can work together to help them achieve their goals and thrive in their personal lives!</p>
                        <p class="mt-5"><a href="{{url('contact-us')}}" class="btn btn-primary">Get In Touch</a></p>
                    </div>
                    <div class="col-lg-5 ml-auto">
                        <img src="assets/frontend/images/personal_problems.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
